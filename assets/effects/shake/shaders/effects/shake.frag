...
uniform sampler2D g_Texture1; // {"material":"ui_editor_properties_shake_direction_map","mode":"flowmask","default":"util/noflow"}
uniform sampler2D g_Texture2; // {"material":"ui_editor_properties_shake_phase","mode":"opacitymask","default":"util/white"}
